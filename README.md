...
A Simple game where a human user competes against an AI agent in a battle to collect the most points and survive.
...
>**ℹ️ INFO**
>
>*More info can be found in the [Lore](https://rchdev.github.io/game-of-points/lore/) section of the docs.*
